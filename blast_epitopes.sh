...
#db=data/entrez_proteins/cov_protein_2804_blast_db/protein_2804_blast_db
...
#out=data/unexposed_epitopes/blast_unexposed_epitopes.batch_entrez.tsv
#query=data/unexposed_epitopes/unexposed_epitopes.fasta
...
#out=data/three_epitopes.tsv
#query=data/three_epitopes.fasta
...
#out=data/unexposed_epitopes/blast_unexposed_epitopes.prokka_db.tsv
#query=data/unexposed_epitopes/unexposed_epitopes.fasta

#out=data/deconvoluted_epitopes/blast_deconvoluted_epitopes.prokka_db.tsv
#query=data/deconvoluted_epitopes/deconvoluted_epitopes.fasta

## Blastp NCBI Virus annotations ##
#db=data/ncbi_virus_proteins/NCBI_virus_CoV_protein_blast_db/NCBI_virus_CoV_protein_blast_db

#out=data/wuhan-hu-1/blast_wuhan_epitopes.txt
#query=data/wuhan-hu-1/wuhan-hu-1_epitopes.fasta

#out=data/unexposed_epitopes/blast_unexposed_epitopes.txt
#query=data/unexposed_epitopes/unexposed_epitopes.fasta
